1. Running genPhotonStatistics.py simulates the photon probabilities and saves the results in a .npz file, with the file name encoding the simulation parameters.
